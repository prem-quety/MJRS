...
<html lang="en">
<?php
$page_title = "Corporate Tax (T2) – MJRS Associates | Accurate, Efficient, Compliant";
$page_description = "T2 return preparation with clean working papers, schedule accuracy, and proactive planning. Minimize risk and keep cash flow predictable.";
$page_keywords = "T2 Corporate Tax Return Canada, Small Business Tax, CCPC, Capital Cost Allowance, Loss Carryforward, CRA Filing, MJRS Associates";
$page_robots = "index, follow";
$page_url = "https://mjrsassociates.ca/single-service/tax-corporate";
        ...
        <section
            ...
            <div class="relative z-10 max-w-4xl px-6 text-center text-white">
                ...
                <h1 class="fade-up text-5xl md:text-7xl font-extrabold tracking-tight leading-[1.05]"
                    ...
                    File Clean. Plan Ahead.<br>
                    <span class="text-brand-gold">Own Your Year-End.</span>
                </h1>
                <p class="fade-up mt-6 text-lg md:text-xl text-gray-100 max-w-3xl mx-auto leading-relaxed font-light"
                    style="animation-delay:.8s">
                    Accurate T2 filings with the right schedules, working papers, and documentation—built to reduce risk
            ...
            <div class="bg-gray-50 w-full md:w-2/3 flex items-center">
                <div class="max-w-xl px-10 md:px-16 py-20">
                    ...
                    <h3 class="text-3xl md:text-4xl font-extrabold text-brand-black mb-8 leading-snug">
                        The right schedules. <span class="text-brand-red">The right story.</span> The right outcome.
                    </h3>
            ...
            <div class="relative z-10 max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-12 items-start">
                ...
                <aside class="hidden md:block sticky top-24 self-start space-y-8 h-fit">
                    ...
                    <div class="rounded-2xl bg-brand-black text-white p-8 text-center shadow-sm">
                        <p class="text-xs uppercase tracking-wide text-brand-gold mb-2">Year-end coming up?</p>
                        <h4 class="text-lg font-semibold leading-snug mb-4">
                            File clean, file early—<br><span class="text-brand-gold">sleep easier.</span>
                        </h4>
                        <a href="./contact"
